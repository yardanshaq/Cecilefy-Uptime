...
requests for Cecilefy Uptime. I never thought the GitHub community would be so nice!
...
## Can I Create a Pull Request for Cecilefy Uptime?
...
- <details><summary><b>Security Fixes</b> (click to expand)</summary>
  ...
  [advisory]: https://github.com/yardanshaq/cecilefy-uptime/security/advisories/new
  [issue]:
    https://github.com/yardanshaq/cecilefy-uptime/issues/new?template=security_issue.yml
...
- <details><summary><b>Translations / Internationalisation (i18n)</b> (click to expand)</summary>
  ...
  weblate, please see
  [these instructions](https://github.com/yardanshaq/cecilefy-uptime/blob/master/src/lang/README.md).
...
- <details><summary><b>New Monitoring Types</b> (click to expand)</summary>
  ...
  - `server/cecilefy-uptime-server.js` is where the monitoring backend needs to be
...
- <details><summary><b>Pull Request Guidelines</b> (click to expand)</summary>
  ...
  1. **Fork** the [Cecilefy-Uptime repository].

  [Cecilefy-Uptime repository]: https://github.com/yardanshaq/cecilefy-uptime/
  ...
  [Compare & Pull Request]: https://github.com/yardanshaq/cecilefy-uptime/compare/
...
- Make sure the **UI/UX is close to Cecilefy Uptime**.
...
[milestone]: https://github.com/yardanshaq/cecilefy-uptime/milestones
...
you can finally start the app. The goal is to make the Cecilefy Uptime installation
...
- `cecilefy-uptime-server.js` (CecilefyUptimeServer class, main logic should be here,
...
Cecilefy Uptime Frontend is a single page application (SPA). Most paths are handled
by Vue Router.
...
See: <https://github.com/yardanshaq/cecilefy-uptime/tree/master/db/knex_migrations>
...
If you want to help by translating Cecilefy Uptime into your language, please visit
the [instructions on how to translate using weblate].

[instructions on how to translate using weblate]:
  https://github.com/yardanshaq/cecilefy-uptime/blob/master/src/lang/README.md
...
<https://github.com/yardanshaq/cecilefy-uptime-wiki>
...
- `2.x.x-beta.x`
- `nightly2`: Dev build
- `base2`: Basic Debian setup without Cecilefy Uptime source code (Full features)
- `base2-slim`: Basic Debian setup without Cecilefy Uptime source code
...
- `nightly`: Dev build
- `base-debian`: Basic Debian setup without Cecilefy Uptime source code
- `pr-test`: For testing pull request without setting up a local environment
- `base-alpine`: (Deprecated) Basic Alpine setup without Cecilefy Uptime source code
...
<https://github.com/yardanshaq/cecilefy-uptime/issues?q=sort%3Aupdated-desc>
...
- <details><summary><b>Release</b> (click to expand)</summary>
  ...
  - [ ] Check all tags is fine on
        <https://hub.docker.com/r/louislam/cecilefy-uptime/tags>
...
- <details><summary><b>Release Wiki</b> (click to expand)</summary>
  ...
  **Setup Repo**
  ...
  ```bash
  git clone https://github.com/yardanshaq/cecilefy-uptime-wiki.git
  cd cecilefy-uptime-wiki
  git remote add production https://github.com/yardanshaq/cecilefy-uptime.wiki.git
  ```
