    ...
    <div class="mb-3">
        ...
        <div class="form-text">
            <i18n-t tag="p" keypath="Read more:">
                <a href="https://docs.keephq.dev/providers/documentation/cecilefyuptime-provider" target="_blank">https://docs.keephq.dev/providers/documentation/cecilefyuptime-provider</a>
            </i18n-t>
        </div>
    </div>
