...
// DO NOT IMPORT HERE IF THE MODULES USED `CecilefyUptimeServer.getInstance()`, put at the bottom of this file instead.

/**
 * `module.exports` (alias: `server`) should be inside this class, in order to avoid circular dependency issue.
 * @type {CecilefyUptimeServer}
 */
class CecilefyUptimeServer {
    /**
     ...
     * @returns {CecilefyUptimeServer} Server instance
     */
    static getInstance() {
        if (CecilefyUptimeServer.instance == null) {
            CecilefyUptimeServer.instance = new CecilefyUptimeServer();
        }
        return CecilefyUptimeServer.instance;
    }
     ...
     */
    constructor() {
        // Set axios default user-agent to Cecilefy-Uptime/version
        ...
        // Set Monitor Types
        CecilefyUptimeServer.monitorTypeList["real-browser"] = new RealBrowserMonitorType();
        CecilefyUptimeServer.monitorTypeList["tailscale-ping"] = new TailscalePing();
        CecilefyUptimeServer.monitorTypeList["dns"] = new DnsMonitorType();
        CecilefyUptimeServer.monitorTypeList["mqtt"] = new MqttMonitorType();
        CecilefyUptimeServer.monitorTypeList["smtp"] = new SMTPMonitorType();
        CecilefyUptimeServer.monitorTypeList["group"] = new GroupMonitorType();
        CecilefyUptimeServer.monitorTypeList["snmp"] = new SNMPMonitorType();
        CecilefyUptimeServer.monitorTypeList["mongodb"] = new MongodbMonitorType();
        CecilefyUptimeServer.monitorTypeList["rabbitmq"] = new RabbitMqMonitorType();
        CecilefyUptimeServer.monitorTypeList["manual"] = new ManualMonitorType();
     ...
     */
    getUserAgent() {
        return "Cecilefy-Uptime/" + require("../package.json").version;
    }
