...
class StatusPage extends BeanModel {
    ...
    static async handleStatusPageRSSResponse(response, slug) {
        ...
        if (statusPage) {
            ...
            response.status(404).send(CecilefyUptimeServer.getInstance().indexHTML);
        }
    }
    ...
    static async renderRSS(statusPage, slug) {
        ...
        const feed = new Feed({
            title: "cecilefy uptime rss feed",
    ...
    static async renderHTML(indexHTML, statusPage) {
        ...
        // Preload data
        // Add jsesc, fix https://github.com/yardanshaq/cecilefy-uptime/issues/2186
    ...
    static async getMaintenanceList(statusPageId) {
        try {
            ...
            for (const maintenanceID of maintenanceIDList) {
                let maintenance = CecilefyUptimeServer.getInstance().getMaintenance(maintenanceID);
