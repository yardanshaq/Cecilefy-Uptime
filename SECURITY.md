...
1. Please report security issues to
   <https://github.com/yardanshaq/cecilefy-uptime/security/advisories/new>.
2. Please also create an empty security issue to alert me, as GitHub Advisories
   ...
   <https://github.com/yardanshaq/cecilefy-uptime/issues/new?assignees=&labels=help&template=security.md>
...
### Cecilefy Uptime Versions

You should use or upgrade to the latest version of Cecilefy Uptime. All `1.X.X`
