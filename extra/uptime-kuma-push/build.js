...
const supportedPlatforms = [
    {
        name: "linux/amd64",
        bin: "./build/cecilefy-uptime-push-amd64"
    },
    {
        name: "linux/arm64",
        bin: "./build/cecilefy-uptime-push-arm64"
    },
    {
        name: "linux/arm/v7",
        bin: "./build/cecilefy-uptime-push-armv7"
    }
];
...
if (platformObj) {
    ...
    fs.renameSync(filename, "./cecilefy-uptime-push");
    process.exit(0);
} else {
